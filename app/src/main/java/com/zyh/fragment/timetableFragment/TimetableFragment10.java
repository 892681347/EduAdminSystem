 ...
 */
public class TimetableFragment10 extends Fragment {
    ...
    public TimetableFragment getTimetableFragmeent(){
        ...
        List<Fragment> list=(List<Fragment>) TimetableFragment10.this.getFragmentManager().getFragments();
        for(Fragment f:list){
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    ((TimetableFragment) timetableFragment).isFinished[10] = true;
                }catch (Exception e) {
