 ...
 */
public class TimetableFragment7 extends Fragment {
...
//        textView.setText(((TimetableFragment) timetableFragment).timetableList.get(7));
    ...
    public TimetableFragment getTimetableFragmeent(){
        ...
        List<Fragment> list=(List<Fragment>) TimetableFragment7.this.getFragmentManager().getFragments();
        for(Fragment f:list){
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    ((TimetableFragment) timetableFragment).isFinished[7] = true;
                }catch (Exception e) {
